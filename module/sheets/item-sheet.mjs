...
export class ACItemSheet extends ItemSheet {
    ...
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            classes: ["trekadventures", "sheet", "item"],
            width: 520,
            height: 560,
    ...
    /** @override */
    get template() {
        const path = "systems/trekadventures/templates/item";
    ...
    async getData() {
        ...
        foundry.utils.mergeObject(context, {
            ...
            type: item.type,      
            flags: item.flags,      
            trekadventures: CONFIG.trekadventures,
        ...
        //context.apparelTypes = CONFIG.trekadventures.APPAREL_TYPE;
        //}
