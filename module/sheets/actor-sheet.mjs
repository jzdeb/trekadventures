...
export class ACActorSheet extends ActorSheet {
    ...
    static get defaultOptions() {
        return mergeObject(super.defaultOptions, {
            ...
            template: "systems/trekadventures/templates/actor/actor-sheet.html",
            width: 720,
            height: 780,
    ...
    /** @override */
    get template() {
        return `systems/trekadventures/templates/actor/actor-${this.actor.type}-sheet.html`;
    }
    ...
    async getData() {
        ...
        context.trekadventures = CONFIG.trekadventures;
    ...
    activateListeners(html) {
        ...
        html.find('.roll-attribute.clickable').click((event) => {
            ...
            const attrName = game.i18n.localize('trekadventures.Ability.' + attr);
            game.trekadventures.Dialog2d20.createDialog({ rollName: `Roll ${attrName}`, diceNum: 2, attribute: attribute.value, skill: 0, focus: false, complication: complication })
        })
        ...
        html.find('.roll-weapon.clickable').click((event) => {
            ...
            game.trekadventures.Dialog2d20.createDialog({ rollName: item.name, diceNum: 2, attribute: attrValue, skill: skillRank, focus: isFocus, complication: complication, actor: this.actor.system, prefAttribute: prefAttribute, actorId:this.actor._id, itemId: item._id })
        ...
        html.find('.roll-impact.clickable').click((event) => {
            ...
            game.trekadventures.DialogD6.createDialog({ rollName: `${this.actor.name} Impact`, diceNum: impact, trekadventuresRoll: null })
        })
        ...
        /* -------------------------------------------- */
        const editLabel = game.i18n.localize("trekadventures.EDIT");
        const deleteLabel = game.i18n.localize("trekadventures.DELETE");
        const postLabel = game.i18n.localize("trekadventures.POST");
    ...
    _onRollSkill(skillName, rank, attribute, focus) {
        ...
        game.trekadventures.Dialog2d20.createDialog({ rollName: skillName, diceNum: 2, attribute: -1, skill: rank, focus: focus, complication: complication, actor: this.actor.system })
    }
